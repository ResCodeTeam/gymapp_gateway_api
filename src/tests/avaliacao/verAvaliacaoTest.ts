...
describe("Teste ver avaliação aluno", () => {
  beforeEach((done) => {
    chai
      .request(server)
      .post("/auth/login")
  ...
  describe("- Obter avaliação aluno corretamente", () => {
    it("Deve obter avaliação do aluno corretamente", () => {
      return chai
        ...
        .then((res) => {
          ...
          chai
            .expect(res.body[0])
            .to.have.property("users_avaliacoes_treinador_idTousers");
          ...
          if (res.body[0]["medidas_avaliacao"].length > 0) {
            ...
            chai
              .expect(res.body[0]["medidas_avaliacao"][0])
              .to.have.property("medida");
            chai
              .expect(res.body[0]["medidas_avaliacao"][0])
              .to.have.property("unidade_medida");
            chai
              .expect(res.body[0]["medidas_avaliacao"][0])
              .to.have.property("locais_medidas");

            chai
              .expect(res.body[0]["medidas_avaliacao"][0]["medida"])
              .to.be.a("string");
            chai
              .expect(res.body[0]["medidas_avaliacao"][0]["unidade_medida"])
              .to.be.a("string");
            chai
              .expect(res.body[0]["medidas_avaliacao"][0]["locais_medidas"])
              .to.be.a("object");
            ...
            chai
              .expect(res.body[0]["medidas_avaliacao"][0]["locais_medidas"])
              .to.have.property("unilado");

            chai
              .expect(
                res.body[0]["medidas_avaliacao"][0]["locais_medidas"][
                  "descricao"
                ]
              )
              .to.be.a("string");
            chai
              .expect(
                res.body[0]["medidas_avaliacao"][0]["locais_medidas"]["unilado"]
              )
              .to.be.a("boolean");
          }
          ...
          chai
            .expect(res.body[0]["users_avaliacoes_treinador_idTousers"]["nome"])
            .to.be.a("string");
          if (
            res.body[0]["users_avaliacoes_treinador_idTousers"]["imagem_url"] !=
            null
          ) {
            chai
              .expect(
                res.body[0]["users_avaliacoes_treinador_idTousers"][
                  "imagem_url"
                ]
              )
              .to.be.a("string");

      ...
      return chai
        ...
        .then((res) => {
          ...
          if (res.body["medidas_avaliacao"].length > 0) {
            ...
            chai
              .expect(res.body["medidas_avaliacao"][0])
            ...
            chai
              .expect(res.body["medidas_avaliacao"][0]["medida"])
              .to.be.a("string");
            chai
              .expect(res.body["medidas_avaliacao"][0]["unidade_medida"])
              .to.be.a("string");
            chai
              .expect(res.body["medidas_avaliacao"][0]["locais_medidas"])
              .to.be.a("object");
            ...
            chai
              .expect(
                res.body["medidas_avaliacao"][0]["locais_medidas"]["descricao"]
              )
              .to.be.a("string");
            chai
              .expect(
                res.body["medidas_avaliacao"][0]["locais_medidas"]["unilado"]
              )
              .to.be.a("boolean");
          }
          ...
          chai
            .expect(res.body["users_avaliacoes_treinador_idTousers"]["nome"])
            .to.be.a("string");
          if (
            res.body["users_avaliacoes_treinador_idTousers"]["imagem_url"] !=
            null
          ) {
            chai
              .expect(

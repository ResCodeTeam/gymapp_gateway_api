      ...
      return chai
        ...
        .then((res) => {
          ...
          if (res.body["regras_desafio"].length > 0) {
            ...
            chai
              .expect(res.body["regras_desafio"][0])
              .to.have.property("descricao");

            chai
              .expect(res.body["regras_desafio"][0]["descricao"])
              .to.be.a("string");
          }
          ...
          if (res.body["exercicios_desafio"].length > 0) {
            ...
            chai
              .expect(res.body["exercicios_desafio"][0])
            ...
            chai
              .expect(res.body["exercicios_desafio"][0]["n_ordem_exercicio"])
              .to.be.an("number");
            chai
              .expect(res.body["exercicios_desafio"][0]["genero"])
              .to.be.an("number");
            chai
              .expect(res.body["exercicios_desafio"][0]["exercicios"])
              .to.be.an("object");
            chai
              .expect(res.body["exercicios_desafio"][0]["series_desafio"])
              .to.be.an("array");
          }
          ...
          //verificar se array das propriedades estão corretos
          if (
            res.body["exercicios_desafio"][0]["exercicios"]["imagens"].length >
            0
          ) {
            chai
              .expect(
                res.body["exercicios_desafio"][0]["exercicios"]["imagens"]
              )
              .to.be.an("array");

            chai
              .expect(
                res.body["exercicios_desafio"][0]["exercicios"]["imagens"][0]
              )
          ...
          //verificar se array das propriedades estão corretos
          if (
            res.body["exercicios_desafio"][0]["exercicios"]["musculos"].length >
            0
          ) {
            chai
              .expect(
                res.body["exercicios_desafio"][0]["exercicios"]["musculos"][0]
              )
              .to.be.an("object");

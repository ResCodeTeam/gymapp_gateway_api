      ...
      return chai
        ...
        .then((res) => {
          ...
          if (res.body["perfil"].length > 0) {
            ...
            chai
              .expect(res.body["perfil"][0])
              .to.have.property("definicoes_user");
            ...
            if (res.body["perfil"][0]["imagem_url"] != null) {
              chai
                .expect(res.body["perfil"][0]["imagem_url"])
                .to.be.a("string");
            }
            chai
              .expect(res.body["perfil"][0]["definicoes_user"])
              .to.be.a("object");
            chai
              .expect(res.body["perfil"][0]["definicoes_user"])
              .to.have.property("is_privado");
            chai
              .expect(res.body["perfil"][0]["definicoes_user"]["is_privado"])
              .to.be.a("boolean");
          }
          ...
          if (res.body["treinos"].length > 0) {
            ...
            chai
              .expect(res.body["treinos"][0])
              .to.have.property("atividade_id");
            chai
              .expect(res.body["treinos"][0])
              .to.have.property("modalidade_id");
            ...
            if (res.body["treinos"][0]["ginasio_id"] != null) {
              chai
                .expect(res.body["treinos"][0]["atividade_id"])
                .to.be.a("string");
            }
            chai
              .expect(res.body["treinos"][0]["modalidade_id"])
              .to.be.a("string");

      ...
      return chai
        ...
        .then((res) => {
          ...
          if (res.body[0]["treinador"]["imagem_url"] != null) {
            chai
              .expect(res.body[0]["treinador"]["imagem_url"])
              .to.be.a("string");
          }
          ...
          if (res.body[0]["bloco_treino"].length > 0) {
            ...
            chai
              .expect(res.body[0]["bloco_treino"][0])
            ...
            chai
              .expect(res.body[0]["bloco_treino"][0])
              .to.have.property("exercicios_bloco");

            chai
              .expect(res.body[0]["bloco_treino"][0]["nome"])
              .to.be.a("string");
            chai
              .expect(res.body[0]["bloco_treino"][0]["descricao"])
              .to.be.a("string");
            chai
              .expect(res.body[0]["bloco_treino"][0]["exercicios_bloco"])
              .to.be.a("array");
          }
        });
    });

...
adminRouter.get(
  "/admin/ginasio/:ginasioId/modalidades",
  verificarAutenticacao,
  verificarAdmin,
  (req, res) => {
...
adminRouter.delete(
  "/admin/ginasio/:ginasioId/modalidades/:modalidadeId",
  verificarAutenticacao,
  verificarAdmin,
  (req, res) => {
    const userId = res.locals.uid;
    ...
    gymapp_api
      .delete(
        `/admin/${userId}/ginasio/${ginasioId}/modalidades/${modalidadeId}`
      )
      .then((resp) => {
        res.send(resp.data);
      })
...
adminRouter.delete(
  "/admin/marca/:marcaId/localMedida/:localId",
  verificarAutenticacao,
  verificarAdmin,
  (req, res) => {
    const marcaId = req.params.marcaId;
...
adminRouter.get(
  "/admin/ginasio/treinador/ver/:marcaId",
  verificarAutenticacao,
  verificarAdmin,
  (req, res) => {

...
allRouter.delete(
  "/posts/:postId/comentario/:comentarioId/gosto",
  verificarAutenticacao,
  (req, res) => {
    const userId = res.locals.uid;
...
allRouter.delete(
  "/posts/:postId/comentario/:comentarioId",
  verificarAutenticacao,
  (req, res) => {
    const userId = res.locals.uid;
    const postId = req.params.postId;
...
allRouter.put(
  "/destinosNotificacao/notificacao",
  verificarAutenticacao,
  (req, res) => {
    const userId = res.locals.uid;
...
allRouter.get(
  "/ginasio/:ginasioId/desafios/disponiveis",
  verificarAutenticacao,
  (req, res) => {
    const userId = res.locals.uid;
    const ginasioId = req.params.ginasioId;
